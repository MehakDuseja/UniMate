...
def inject_theme() -> None:
    st.markdown(
        ...
        .um-nav-active [data-testid="stMarkdownContainer"] p {
        ...
        .um-save-bar .stButton > button:hover {
        ...
        @media (max-width: 768px) {
            ...
            .um-bottom-nav-wrap .stButton > button {
                border-radius: 12px !important;
        ...
        .um-suggestion-btn .stButton > button {
        ...
        .um-suggestion-btn .stButton > button:hover {
            background: rgba(53, 37, 205, 0.12) !important;
            border-color: var(--primary) !important;
        }

        .um-conv-item .stButton > button {
            font-size: 0.85rem !important;
            padding: 0.4rem 0.65rem !important;
        }

        .um-conv-active .stButton > button {
            background: rgba(79, 70, 229, 0.12) !important;
            color: var(--primary) !important;
            font-weight: 600 !important;
        }
